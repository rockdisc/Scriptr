...
function defaultMarkdownName(name?: string) {
...
ipcMain.handle("desktop:save-markdown", async (_event, payload: SavePayload) => {
...
ipcMain.handle("desktop:save-markdown-as", async (_event, payload: SavePayload) => {
...
ipcMain.handle("desktop:export-markdown", async (_event, payload: SavePayload) => {
  if (typeof payload.markdown !== "string") {
    throw new Error("Missing Markdown content.");
  }
